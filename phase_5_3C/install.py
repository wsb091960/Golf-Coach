...
def cache_bust(text: str) -> str:
    for pattern in ASSET_REFS:
        text = pattern.sub(r"\1?v=5.3C", text)
    return text
...
def main() -> None:
    ...
    backup = ROOT / f"backup_5_3C_{stamp}"
    ...
    print("Phase 5.3C installed: tabbed Coaching Assistant and video recommendations are ready.")
